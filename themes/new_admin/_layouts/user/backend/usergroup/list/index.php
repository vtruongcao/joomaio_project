<div class="page-breadcrumb p-0 pt-4 mb-4">
    <div class="row">
        <div class="col-7 align-self-center">
            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">User Groups</h3>
        </div>
            ...
            <div class="card-body">
				...
				<form action="<?php echo $this->link_list ?>" method="POST" id="formList">
					...
					<table id="datatables-buttons" class="table table-striped table-bordered" style="width:100%">
						...
						<tbody>
							<?php while($this->list->hasRow()) echo $this->render('backend.usergroup.list.row', []); ?> 
						</tbody>
					</table>
				</form>
